...
def testingWeather():
  api_key="55fc2deed09d8d1242fb2135f6f322c7"
...
Button(root, command = testingWeather, text = "Check Weather", font="Arial 10", bg='lightblue', fg='black', activebackground="teal", padx=5, pady=5 ).pack(pady= 20)
